...
g.cor.input =  pft_ask_google(g.cor.keywords,country_of_interest="DE",from="2010-07-31",to="2017-07-31",status= 1,prefix="g.cor.")

# b) trends queries:
g.trends.input =  pft_ask_google(g.trends.keywords,country_of_interest="DE",from="2010-07-31",to="2017-07-31",status= 1,prefix="g.trends.")
...
earthGrid <- expand.grid(.nlgree = 1, .nprune = 2:25)
svmGrid <-  expand.grid(sigma= 2^c(-25, -20, -15,-10, -5, 0), C= 2^c(0:4))
cubistGrid <- expand.grid(.committees = c(1, 5, 10, 50, 75, 100),.neighbors=c(0,1,3,5,7,9))
nnetGrid <- expand.grid(.nlcay = c(0.001, .01, .1),.size = seq(1, 27, by = 2),.bag = FALSE)
gbmGrid <- expand.grid(.interaction.nlpth = seq(1, 7, by = 2), .n.trees = seq(100, 1000, by = 50),.shrinkage = c(0.01, 0.1),.n.minobsinnode = c(10))
...
formula.list = list(glmnet.mod = list(y= y.train ,
                    ...
                    glmnet.pca.mod = list(y= y.train ,
                                          ...
                                          tuneGrid = glmnGrid,
                                          trControl = controlObject),
                    plsModel = list(y= y.train ,
                                    x = df.train,
                                    method = "pls",
                                    tuneLength = 20,
                                    trControl = controlObject),
                    enetModel = list(y= y.train ,
                                     x = df.train,
                                     method = "enet",
                                     tuneGrid = enetGrid,
                                     trControl = controlObject),
                    earthModel = list(y= y.train ,
                                      x = df.train,
                                      method = "earth",
                                      tuneGrid = earthGrid,
                                      trControl = controlObject),
                    svmRModel = list(y= y.train ,
                                     x = df.train,
                                     method = "svmRadial",
                                     tuneLength = 25,
                                     tuneGrid =svmGrid, #   tuneGrid =svmGrid2,
                                     trControl = controlObject),
                    rpartModel = list(y= y.train ,
                                      x = df.train,
                                      method = "rpart",
                                      tuneLength = 30,
                                      trControl = controlObject),
                    ctreeModel = list(y= y.train ,
                                      x = df.train,
                                      method = "ctree",
                                      tuneLength = 10,
                                      trControl = controlObject),
                    nnetModel = list(y= y.train ,
                                     x = df.train,
                                     method = "avNNet",
                                     tuneGrid = nnetGrid,
                                     preProc = c("pca"),
                                     ...
                                     maxit = 500,
                                     trControl = controlObject),
                    treebagModel = list(y= y.train ,
                                        x = df.train,
                                        method = "treebag",
                                        trControl = controlObject),
                    rfModel = list(y= y.train , ### takes too long!!!
                                   x = df.train,
                                   method = "rf",
                                   tuneLength = 10,
                                   ntrees = 500,
                                   importance = TRUE,
                                   trControl = controlObject),
                    gbmModel = list(y= y.train ,
                                    x = df.train,
                                    method = "gbm",
                                    tuneGrid = gbmGrid,
                                    verbose = FALSE,
                                    trControl = controlObject),
                    #mtModel = list(y= y.train , # doesnt work bc java-mac issues?!
                    #              x = df.train,
                    #             method = "M5",
                    #            trControl = controlObject),
...
#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#
#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#
#         WARNING :      THIS CODE CAN TAKE HOURS TO RUN!!!                               #
#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#
#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#
#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#
...
# paralel plot: showing cv results?!
