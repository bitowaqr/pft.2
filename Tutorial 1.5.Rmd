...
*We would like to point out that when we speak of 'prediction', we use the term in its [statistical sense](https://en.wikipedia.org/wiki/Prediction#Statistics). We do not mean ’forecasting'. We are <u>'Nowcasting'</u>: We observe what people are doing on the internet during this week and infer from this information how many influenza cases there are now.*
<br><br><br>
